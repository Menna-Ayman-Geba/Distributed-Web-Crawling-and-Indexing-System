...
def index_files(file_queue, indexer_id):
    ...
    for root, dirs, files in os.walk(index_dir):
        for file in files:
            ...
            # Modified to use a single 'index_data' folder without indexer_id subfolders
...
def run_indexers(num_indexers):
    ...
    # Fetch list of crawled files from S3
